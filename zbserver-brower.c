...
void MXJ_SendConfigMessage( uint16_t ,uint8_t,uint8_t, MXJ_CONFIG_STRUCT);
 ...
 *
 * @brief   Send the register message to endpoint.
 *
 * @param   none
 *
 * @return  none
